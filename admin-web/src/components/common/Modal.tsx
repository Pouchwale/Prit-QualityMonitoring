...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-900/60 backdrop-blur-[1px] animate-in fade-in duration-150">
      <div
        className={`bg-white rounded-lg border border-line-strong shadow-xl w-full ${maxWidthClasses[maxWidth]} flex flex-col max-h-[calc(100dvh-1.5rem)] sm:max-h-[90vh] overflow-hidden`}
        role="dialog"
        aria-modal="true"
      >
        {/* Header */}
        ...
        {/* Content */}
        <div className="px-4 sm:px-5 py-4 overflow-y-auto overflow-x-hidden space-y-4 text-[13px]">
          {children}
        </div>
